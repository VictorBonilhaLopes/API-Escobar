    ...
    <div style={{ ...containerStyle, maxWidth: "1000px", margin: "auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
        ...
        <button
          ...
          style={{
            backgroundColor: "#20B2AA", // Cor teal (verde-azulado)
          ...
          onMouseOver={(e) => (e.target.style.backgroundColor = "#3CB371")} // Efeito hover: verde médio
          onMouseOut={(e) => (e.target.style.backgroundColor = "#20B2AA")} // Retorna ao teal
        >
          Criar Produto
        </button>
      </div>
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onLogout}
        style={{
          backgroundColor: "#f44336", // Cor vermelha mantida
          color: "white",
          border: "none",
          padding: "10px 20px",
          borderRadius: "5px",
